...
//ESP32 PINs
const int SPI_SCK = 4; 			//board or mcu specific
const int SPI_MISO = 5; 			//board or mcu specific
const int SPI_MOSI = 18; 			//board or mcu specific
const int SPI_CS = 19; 				//select any pin
const int RADIO_INPUT_PIN = 15; 	//select any pin, this is the TX-PIN
const int RADIO_OUTPUT_PIN = 2; 	//select any pin, this is the RX-PIN
